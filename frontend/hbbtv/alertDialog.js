...
function showAlertDialog(q1, q2, buttons, _checked, _focused, callback, cancel) {
  ...
  alertDialog.buttonbar = new ButtonBar(
    [VK_ENTER, VK_BACK, VK_BLUE],
    { VK_ENTER: "Select", VK_BACK: "Back", VK_BLUE: "Close" },
    "buttonbar_dialog"
  );
  ...
  if (buttons.length > 0) {
    $.each(buttons, function (i, label) {
      ...
      if (i == alertDialog.focused) {
        alertDialogButton.addClass("focused");
      }
