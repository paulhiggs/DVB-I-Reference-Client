    ...
    switch (keyCode) {
      ...
      case VK_UP:
        if (keyCode == VK_UP && dialog.focused) {
          if ($(".dialogButton").eq(alert.focused).hasClass("firstvisible") && dialog.focused > 0) {
            animating = true;
            $(".dialogButton").eq(alert.focused).removeClass("firstvisible");
            $(".dialogButton").eq(alert.focused).prev().addClass("firstvisible");
            ...
            $("#dialogWrapper").animate(
              {
                scrollTop: $("#dialogWrapper").scrollTop() - $(".dialogButton").eq(alert.focused).outerHeight(true),
              },
              {
                duration: 250,
                easing: "linear",
          ...
          if ($(".dialogButton").eq(alert.focused).hasClass("lastvisible") && dialog.focused + 1 < dialog.options) {
            animating = true;
            $(".dialogButton").eq(alert.focused).removeClass("lastvisible");
            $(".dialogButton").eq(alert.focused).next().addClass("lastvisible");
        ...
        $(".dialogButton").eq(alert.focused).addClass("focused");
        break;
